...
- A drag starts only after the pointer travels 4pt, and unit regions are hit-tested first, so click-to-cycle units keeps priority over reordering. Releasing outside the dashboard abandons the move. Preserve both behaviors.
